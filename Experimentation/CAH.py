...
def CAH(data, methode, pas, criter):
    ...
    #print (f"Les points sont regroupés dans les clusters suivants : {clusters}")
    print("Le score de DB est :", davies_bouldin_score(data, clusters))
    return ("Le score de silhouette est :", silhouette_score(data, labels = clusters, metric='euclidean'))
